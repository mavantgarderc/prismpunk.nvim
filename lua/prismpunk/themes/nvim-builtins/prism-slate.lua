...
M.get = function(opts, plt)
  ...
  return {
    ...
    ui = {
      ...
      bg_search = plt.goldCore,
      bg_visual = plt.oliveGreen,
      bg_statusline = plt.goldDeep,
      border = plt.stoneGray,
      header1 = plt.skyCore,
      header2 = plt.goldBright,
      special = plt.coralBright,
      nontext = plt.bg_light,
      whitespace = plt.stoneGray,
      win_separator = plt.stoneGray,
      indent = plt.bg_lighter,
      indent_scope = plt.skyCore,
      picker = plt.copperCore,
      yank = plt.goldBright,
      mark = plt.coralCore,
      ...
      tabline = {
        ...
        fg_alternate = plt.goldBright,
        indicator = plt.skyCore,
      },
    },
    syn = {
      ...
      special2 = plt.skyCore,
      special3 = plt.jadeCore,
    ...
    diag = {
      ...
      virtual_text_warning = plt.warningYellow,
      virtual_text_info = plt.infoBlue,
      virtual_text_ok = plt.successGreen,
      virtual_text_hint = plt.goldCore,
    },
    diff = {
      add = plt.jadeCore,
