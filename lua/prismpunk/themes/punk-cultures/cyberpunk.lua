...
M.get = function(opts, plt)
  ...
  return {
    ...
    ui = {
      ...
      border = plt.cyberCyanBright,
      header1 = plt.neonPinkBright,
      header2 = plt.cyberCyanBright,
      special = plt.dataVioletCore,
      nontext = plt.fg_dark,
      whitespace = plt.darkGray,
      win_separator = plt.cyberCyanBright,
    ...
    syn = {
      ...
      comment = plt.darkGrayLight,
      constant = plt.hologramYellowCore,
      deprecated = plt.darkGray,
