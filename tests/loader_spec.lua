...
describe("loader.clear_theme_cache", function()
  it("is a callable function", function()
    assert.is_function(loader.clear_theme_cache)
    loader.clear_theme_cache()
  end)
end)

describe("loader._highlight_cache and _highlight_cache_stats", function()
  ...
  it("exposes internal stats for testing", function()
    assert.is_table(loader._highlight_cache_stats)
  end)
end)
